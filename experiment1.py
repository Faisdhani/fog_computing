...
from yafs.distribution import deterministic_distribution as deterministicDistribution
    ...
    for f in functions:
        ...
        if "Cluster" in f:
            ...
            for idWL in id_lambdas:
                ...
                # kv is (k, v)
                for dev, value in sorted(centralWL[idx].iteritems(), key=lambda kv: (kv[1], kv[0]),reverse=True):
                    # print("%s: %s" % (dev, value))
